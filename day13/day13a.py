...
def check_one_reflection(pattern, line_number):
    """
    Checks whether a single horizontal reflection is valid
    ...
    # Return True if the horizontal reflection of pattern2 is equal to pattern 1
    return np.array_equal(pattern1, pattern2[::-1, :])
